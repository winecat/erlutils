...
-spec ip_to_integer({N1 :: integer(), N2 :: integer(), N3 :: integer(), N4 :: integer()}) -> Result :: integer().
ip_to_integer({N1, N2, N3, N4}) ->
    (N1 * 16777216) + (N2 * 65536) + (N3 * 256) + N4.

%% @doc 数值转成ip地址
-spec integer_to_ip(Integer :: integer()) -> {N1 :: integer(), N2 :: integer(), N3 :: integer(), N4 :: integer()}.
